...
const Navigation = () => {
  ...
  return (
    <>
      ...
      <nav className="sticky  top-0 w-full h-14 py-6  z-20  ">
      ...
      >
        ...
        <div className="flex-1 flex justify-start items-center gap-4 pr-8  ">
          <div
            className="hidden rounded-br-md absolute top-[48px] left-0 flex-col gap-4  bg-background  dark:bg-background w-96 h-74 p-6  
          ...
          <div
            ...
            className="cursor-pointer absolute   z-[5] left-2 top-0 
          ...
          >
           <svg viewBox="0 0 287 412"  className='w-6 h-6  ml-4 fill-current  text-copy-primary dark:text-copy-primary'>
    <g  clip-path="url(#a)">
