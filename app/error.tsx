...
export default function Error({
    ...
    <defs>
        <clipPath id="a">
            ...
            <div className='flex flex-col justify-center p-4 mb-12'>
                <h2 className='text-2xl text-copy-primary dark:text-copy-primary font-MoonGet uppercase opacity-30  tracking-widest'>Something went wrong!</h2>
